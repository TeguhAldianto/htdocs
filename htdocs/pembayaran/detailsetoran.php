...
<head>
    ...
    <style>
        ...
        /* Highlight Total */
        .total-row { background-color: #0f172a !important; color: white !important; }
        .total-row td { border: none !important; }
        .amount-highlight { color: #fbbf24; font-weight: 800; font-size: 1.25rem; }
                    ...
                    <table class="table table-striped table-hover mb-0">
                        ...
                        <tbody>
                            <?php if ($daftar_siswa): $no_s = 1; ?>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="6" class="text-center py-5">Tidak ada data rincian siswa.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
